...
export default function DashboardPage() {
  ...
  // Process main hospitals - using IIFE instead of useMemo
  const allMainHospitals = (() => {
    ...
    return allHospitalNetworks.reduce((hospitals: any[], network: any) => {
      ...
      const hospitalWithNetworkInfo = mainHospitals.map((hospital: any) => {
      ...
      return [...hospitals, ...hospitalWithNetworkInfo];
    }, []);
